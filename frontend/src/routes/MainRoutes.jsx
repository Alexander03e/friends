...
import { MAIN_URL, NEWS_URL, PROFILE_URL, SIGNIN_URL, SIGNUP_URL, CONTACTS_URL, INFO_URL, POLICY_URL, USERS_URL, USER_PROFILE_URL } from './config'
...
const MainRoutes = ({isAuth, news, setNews, initialNews, setInitialNews, setAuth}) => {
  ...
  const baseRoutes = [
    ...
    {path: USERS_URL, element: <Users />},
    {path: USER_PROFILE_URL, element: <UserProfile />},
  ]
