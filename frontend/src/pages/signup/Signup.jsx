    ...
    <section className="signin">
      <div className="container">
        <form className='form'>
          ...
          <input name='password1' value={state.password1} onChange={e => setState({...state, [e.target.name]: e.target.value})} className='form__input' placeholder='Пароль'/>
          <input name='password2' value={state.password2} onChange={e => setState({...state, [e.target.name]: e.target.value})} className='form__input' placeholder='Повторите пароль'/>
